...
categories_list = ["Electronics", "Fashion", "Home & Office", "Fitness"]
cats = {}
...
# Note: These paths assume you have images saved in your media root, 
# e.g., `media/products/smartphone_x.jpg`
