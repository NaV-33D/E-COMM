        ...
        <div className="sticky top-0 z-50">
            ...
            <nav className="bg-[#131921] text-white">
                <div className="max-w-[1500px] mx-auto px-4 h-[64px] flex items-center gap-4">
                    ...
                    {/* Logo */}
                    <Link to="/" className="flex items-center gap-1.5 shrink-0 px-2 py-1 border border-transparent hover:border-white rounded">
                    ...
                    <div className="flex items-center gap-1 ml-auto shrink-0">
                        ...
                        {!isLoggedIn ? (
                            <div className="hidden sm:flex items-center gap-1">
                                <Link to="/login" className="px-3 py-1.5 text-xs leading-tight border border-transparent hover:border-white rounded">
                                    <span className="block text-slate-300">Hello, sign in</span>
                                    <span className="block font-bold">Account & Lists</span>
                                </Link>
                                <Link to="/signup" className="px-3 py-2 text-sm font-semibold bg-[#FF9900] text-[#131921] rounded hover:bg-[#e88a00] transition-colors">
                                    Sign Up
                                </Link>
                            </div>
                        ) : (
                        ...
                        {/* Wishlist */}
                        <Link to="/wishlist" className="relative px-3 py-1.5 border border-transparent hover:border-white rounded flex flex-col items-center">
                        ...
                        {/* Cart */}
                        <Link to="/cart" className="relative px-3 py-1.5 border border-transparent hover:border-white rounded flex items-end gap-1">
                            ...
                            <span className="text-sm font-bold hidden sm:block mb-0.5">Cart</span>
                        </Link>
                    </div>
                </div>
            </nav>
            ...
            <nav className="bg-[#232F3E] text-white text-sm">
                <div className="max-w-[1500px] mx-auto px-4 h-10 flex items-center gap-5 overflow-x-auto no-scrollbar">
                    <Link to="/" className="whitespace-nowrap font-semibold px-1 py-1 hover:text-[#FF9900] transition-colors">Home</Link>
                    <Link to="/products" className="whitespace-nowrap px-1 py-1 hover:text-[#FF9900] transition-colors">All Products</Link>
                    <Link to="/wishlist" className="whitespace-nowrap px-1 py-1 hover:text-[#FF9900] transition-colors">Wishlist</Link>
                    <Link to="/about" className="whitespace-nowrap px-1 py-1 hover:text-[#FF9900] transition-colors">About Us</Link>
                    <Link to="/contact" className="whitespace-nowrap px-1 py-1 hover:text-[#FF9900] transition-colors">Contact Us</Link>
                </div>
            </nav>
        </div>
    );
